...
public class BoardConfigSaveService {
    ...
    public void save(BoardForm boardForm, Errors errors){
        ...
        board.setBUse(boardForm.isBUse());
        board.setRowsOfPage(boardForm.getRowsOfPage());
        board.setShowList(boardForm.isShowList());
        board.setCategory(boardForm.getCategory());

        board.setLiAccessRole(Role.valueOf(boardForm.getLiAccessRole())); // String -> Role
        board.setVAccessRole(Role.valueOf(boardForm.getVAccessRole()));
        board.setWAccessRole(Role.valueOf(boardForm.getWAccessRole()));
