...
- 2023.05.25
  - 사이트 설정 관련 오류 수정
  - 오류 : 초기에 siteConfig 초기값이 없어, 프론트 메인 페이지에 meta 데이터로 입력해놓은 코드에서 null값으로 인한 오류 발생.
  - 해결 : Interceptor 측에서 siteConfig value null인 경우, 빈값("") 대입하도록 메서드 정의.
    - ${@빈객체} 를 통해 빈객체 자체 가져오기.
- 2023.05.27
  - 게시판 설정 삭제 기능 추가하기